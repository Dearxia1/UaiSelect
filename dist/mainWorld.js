var P=Object.defineProperty;var R=(w,h,x)=>h in w?P(w,h,{enumerable:!0,configurable:!0,writable:!0,value:x}):w[h]=x;var N=(w,h,x)=>R(w,typeof h!="symbol"?h+"":h,x);(function(){if(window.__UAISELECT_MAIN_WORLD_INITIALIZED__)return;window.__UAISELECT_MAIN_WORLD_INITIALIZED__=!0;const h=/(?:https?:\/\/[^/\s]+\/|file:\/\/\/?)((?:src|app|pages|components|lib|views)\/[^?:\s"']+\.[a-zA-Z0-9]+)(?:\?[^:\s"']*)?:(\d+)(?::(\d+))?/,x=["flex","grid","inline","block","hidden","p-","px-","py-","pt-","pb-","pl-","pr-","m-","mx-","my-","mt-","mb-","ml-","mr-","bg-","text-","border-","rounded-","shadow-","w-","h-","min-w-","max-w-","min-h-","max-h-","gap-","space-","items-","justify-","self-","opacity-","transition-","duration-","ease-","font-","tracking-","leading-","text-","relative","absolute","fixed","sticky","inset-","top-","bottom-","left-","right-","z-","hover:","focus:","active:","dark:","sm:","md:","lg:","xl:","2xl:","group-hover:","cursor-","overflow-","select-"];function _(t){return!t||typeof t!="string"?!1:x.some(e=>t.startsWith(e)||t===e)}function b(t){if(!t||typeof t!="string")return"";let e=t.replace(/\\/g,"/");return e=e.replace(/^\/@fs\//,"/"),e=e.replace(/\?.*$/,""),e=e.replace(/^webpack:\/\/[^/]*\//,""),e=e.replace(/^file:\/\/\/?/,""),e=e.replace(/^\/([a-zA-Z]:)/,"$1"),e}function k(t){if(!t)return null;let e=t,n=0;for(;e&&n<6;){const a=Object.keys(e);for(let s=0;s<a.length;s++){const i=a[s];if(i.startsWith("__reactFiber$")||i.startsWith("__reactInternalInstance$")){const o=e[i];if(o)return o}}try{const s=Object.getOwnPropertyNames(e);for(let i=0;i<s.length;i++){const o=s[i];if(o.startsWith("__reactFiber$")||o.startsWith("__reactInternalInstance$")){const l=e[o];if(l)return l}}}catch{}e=e.parentElement,n++}return null}function C(t){if(!t)return null;if(typeof t=="string")return t;if(typeof t=="function")return t.displayName||t.name||"AnonymousComponent";if(typeof t=="object"){if(t.$$typeof&&typeof t.$$typeof=="symbol"){const e=t.$$typeof.toString();if(e.includes("react.memo"))return C(t.type)?`Memo(${C(t.type)})`:"Memo";if(e.includes("react.forward_ref"))return t.render&&(t.render.displayName||t.render.name)||"ForwardRef";if(e.includes("react.provider"))return"ContextProvider"}if(t.displayName)return t.displayName;if(t.name)return t.name;if(t.render)return C(t.render)}return null}function S(t){var a,s,i,o,l;if(!t)return null;const e=t._debugSource||((a=t._debugOwner)==null?void 0:a._debugSource);if(e&&e.fileName)return{fileName:b(e.fileName),lineNumber:Number(e.lineNumber)||1,columnNumber:e.columnNumber?Number(e.columnNumber):void 0};const n=((s=t.memoizedProps)==null?void 0:s.__source)||((i=t.pendingProps)==null?void 0:i.__source)||((o=t.memoizedProps)==null?void 0:o._source)||((l=t.pendingProps)==null?void 0:l._source);if(n&&n.fileName)return{fileName:b(n.fileName),lineNumber:Number(n.lineNumber)||1,columnNumber:n.columnNumber?Number(n.columnNumber):void 0};if(Array.isArray(t._debugInfo)){for(const r of t._debugInfo)if(r&&typeof r=="object"){if(r.fileName)return{fileName:b(r.fileName),lineNumber:Number(r.lineNumber)||1,columnNumber:r.columnNumber?Number(r.columnNumber):void 0};if(typeof r.stack=="string"){const m=r.stack.match(h);if(m)return{fileName:b(m[1]),lineNumber:parseInt(m[2],10)||1,columnNumber:m[3]?parseInt(m[3],10):void 0}}}}if(t._debugStack&&typeof t._debugStack=="string"){const r=t._debugStack.match(h);if(r)return{fileName:b(r[1]),lineNumber:parseInt(r[2],10)||1,columnNumber:r[3]?parseInt(r[3],10):void 0}}return null}function L(t){if(!t)return null;let e=null,n=t,a=0;for(;n&&a<30;){const o=S(n);if(o){const l=o.fileName.includes("node_modules");if((o.fileName.includes("/src/")||o.fileName.includes("/app/")||o.fileName.includes("/pages/")||o.fileName.startsWith("src/"))&&!l)return o;!e&&!l&&(e=o)}n=n._debugOwner,a++}let s=t,i=0;for(;s&&i<30;){const o=S(s);if(o){const l=o.fileName.includes("node_modules");if((o.fileName.includes("/src/")||o.fileName.includes("/app/")||o.fileName.includes("/pages/")||o.fileName.startsWith("src/"))&&!l)return o;!e&&!l&&(e=o)}s=s.return,i++}return e}function $(t){var o,l,r;let e;const n=[],a=new Set,s=k(t);if(s){const m=L(s);m&&(e=m);let c=s;for(;c;){const p=C(c.type),f=S(c),d=typeof c.type=="function"||typeof c.type=="object"&&p!==null&&typeof c.type!="string";if(p&&p!=="div"&&p!=="span"&&d&&!a.has(p)){a.add(p);let u;f&&(u={fileName:f.fileName,lineNumber:f.lineNumber,columnNumber:f.columnNumber,componentName:p,framework:"react"}),n.unshift({name:p,tag:typeof c.type=="string"?c.type:"component",source:u,isCustomComponent:!0}),!e&&u&&(e=u)}!e&&f&&(e={fileName:f.fileName,lineNumber:f.lineNumber,columnNumber:f.columnNumber,componentName:p||t.tagName.toLowerCase(),framework:"react"}),c=c.return}}let i=t;for(;i&&i!==document.body&&i!==document.documentElement;){const m=i.getAttribute("data-v-inspector")||i.getAttribute("data-source")||i.getAttribute("data-loc")||i.getAttribute("data-locator")||i.getAttribute("data-source-loc"),c=i.getAttribute("data-inspector-relative-path"),p=i.getAttribute("data-inspector-line");if(m&&!e){const u=m.split(":");if(u.length>=2){let g=u[0],E=parseInt(u[1],10)||1;u[0].length===1&&u.length>=3&&(g=`${u[0]}:${u[1]}`,E=parseInt(u[2],10)||1);const I=((o=g.split("/").pop())==null?void 0:o.replace(/\.[^.]+$/,""))||"Component";e={fileName:b(g),lineNumber:E,componentName:I,framework:g.endsWith(".vue")?"vue":"react"},n.unshift({name:I,tag:i.tagName.toLowerCase(),source:e,isCustomComponent:!0})}}else if(c&&p&&!e){const u=((l=c.split("/").pop())==null?void 0:l.replace(/\.[^.]+$/,""))||"Component";e={fileName:b(c),lineNumber:parseInt(p,10)||1,componentName:u,framework:"react"},n.unshift({name:u,tag:i.tagName.toLowerCase(),source:e,isCustomComponent:!0})}const f=i.__vueParentComponent||i.__vue__;if(f&&f.type){const u=f.type.name||f.type.__name||"VueComponent";!e&&f.type.__file&&(e={fileName:b(f.type.__file),lineNumber:1,componentName:u,framework:"vue"}),n.some(g=>g.name===u)||n.unshift({name:u,tag:i.tagName.toLowerCase(),source:e||void 0,isCustomComponent:!0})}const d=i.__svelte_meta;if(d&&d.loc&&!e){const u=d.loc.file,g=((r=u.split("/").pop())==null?void 0:r.replace(/\.[^.]+$/,""))||"SvelteComponent";e={fileName:b(u),lineNumber:d.loc.line||1,columnNumber:d.loc.column,componentName:g,framework:"svelte"},n.unshift({name:g,tag:i.tagName.toLowerCase(),source:e,isCustomComponent:!0})}i=i.parentElement}return{source:e,hierarchy:n}}function M(t){const e=window.getComputedStyle(t);return{display:e.display,position:e.position,width:`${Math.round(parseFloat(e.width)||0)}px`,height:`${Math.round(parseFloat(e.height)||0)}px`,margin:`${e.marginTop} ${e.marginRight} ${e.marginBottom} ${e.marginLeft}`,padding:`${e.paddingTop} ${e.paddingRight} ${e.paddingBottom} ${e.paddingLeft}`,color:e.color,backgroundColor:e.backgroundColor,fontSize:e.fontSize,fontFamily:e.fontFamily.split(",")[0].replace(/['"]/g,""),borderRadius:e.borderRadius,border:`${e.borderWidth} ${e.borderStyle} ${e.borderColor}`,gap:e.gap!=="normal"?e.gap:void 0,flexDirection:e.display.includes("flex")?e.flexDirection:void 0}}function z(t,e=2){const n=t.cloneNode(!0);function a(s,i){if(i>=e&&s.children.length>0){s.textContent=`<!-- ... ${s.children.length} child elements truncated ... -->`;return}for(let o=0;o<s.children.length;o++)a(s.children[o],i+1)}return a(n,0),{innerSnippet:n.innerHTML.slice(0,1e3),outerSnippet:n.outerHTML.slice(0,1500)}}function y(t,e=0,n=3,a=new WeakSet){if(t==null)return t;const s=typeof t;if(s==="function")return`[Function: ${t.displayName||t.name||"anonymous"}]`;if(s==="symbol")return t.toString();if(s==="bigint")return`${t.toString()}n`;if(s==="string")return t.length>300?`${t.slice(0,300)}...`:t;if(s==="number"||s==="boolean")return t;if(t instanceof Element||t&&t.nodeType)return`<${t.tagName?t.tagName.toLowerCase():"Node"} />`;if(t&&(t.$$typeof||t._isReactElement))return`<${C(t.type)||"ReactNode"} />`;if(e>=n)return Array.isArray(t)?`[Array(${t.length})]`:"[Object]";if(typeof t=="object"){if(a.has(t))return"[Circular]";if(a.add(t),t instanceof Date)return t.toISOString();if(t instanceof RegExp)return t.toString();if(Array.isArray(t))return t.slice(0,25).map(l=>y(l,e+1,n,a));if(t instanceof Map){const l={};let r=0;for(const[m,c]of t.entries()){if(r++>25)break;l[String(m)]=y(c,e+1,n,a)}return l}if(t instanceof Set)return Array.from(t).slice(0,25).map(l=>y(l,e+1,n,a));const i={},o=Object.keys(t).slice(0,35);for(const l of o)if(!(l==="_owner"||l==="_store"||l==="$$typeof"||l==="__self"||l==="__source"||l==="children"))try{i[l]=y(t[l],e+1,n,a)}catch{i[l]="[Unserializable]"}return i}return String(t)}function T(t){const e=[],n=new Set;let a,s;const i=k(t);if(i){let r=i,m=i;for(;r&&!((typeof r.type=="function"||typeof r.type=="object"&&r.type!==null&&typeof r.type!="string")&&(r.memoizedProps||r.memoizedState));)r=r.return;const c=r||m,p=(c==null?void 0:c.memoizedProps)||(c==null?void 0:c.pendingProps)||i.memoizedProps||i.pendingProps;if(p&&typeof p=="object"){const f={};for(const d of Object.keys(p)){if(d==="children"||d==="key"||d==="ref"||d==="__source"||d==="__self")continue;const u=p[d];d.startsWith("on")&&d.length>2&&/[A-Z]/.test(d[2])?n.has(d)||(n.add(d),e.push({name:d,handlerName:typeof u=="function"?u.displayName||u.name||"anonymous":"handler"})):f[d]=u}Object.keys(f).length>0&&(a=y(f))}if(c!=null&&c.memoizedState)if(typeof c.type=="function"){const f={};let d=c.memoizedState,u=0;for(;d&&u<20;){if(d.memoizedState!==void 0&&!(d.memoizedState&&typeof d.memoizedState=="object"&&("create"in d.memoizedState||"destroy"in d.memoizedState||"tag"in d.memoizedState&&"inst"in d.memoizedState))){const E=y(d.memoizedState);E!==void 0&&(f[`state_${u}`]=E)}d=d.next,u++}Object.keys(f).length>0&&(s=f)}else typeof c.memoizedState=="object"&&(s=y(c.memoizedState))}let o=t;for(;o&&o!==document.body&&o!==document.documentElement;){const r=o.__vueParentComponent||o.__vue__;if(r){r.props&&typeof r.props=="object"&&Object.keys(r.props).length>0&&(a={...a,...y(r.props)});const m=r.setupState||r.data;m&&typeof m=="object"&&Object.keys(m).length>0&&(s={...s||{},...y(m)});break}o=o.parentElement}const l=["onclick","onchange","onsubmit","onkeydown","onkeyup","oninput","onfocus","onblur"];for(const r of l){const m=t[r]||t.getAttribute(r);if(m){const c="on"+r.slice(2).charAt(0).toUpperCase()+r.slice(3);n.has(c)||(n.add(c),e.push({name:c,handlerName:typeof m=="function"?m.name||"inline":String(m).slice(0,40)}))}}if(!(!a&&!s&&e.length===0))return{props:a,state:s,events:e.length>0?e:void 0}}function A(t){const e=t.getBoundingClientRect(),n=Array.from(t.classList||[]),a=n.filter(_),s=n.filter(p=>!_(p)),{source:i,hierarchy:o}=$(t);o.length===0&&o.push({name:`<${t.tagName.toLowerCase()}>`,tag:t.tagName.toLowerCase(),isCustomComponent:!1});const{innerSnippet:l,outerSnippet:r}=z(t),m=M(t),c=T(t);return{tagName:t.tagName.toLowerCase(),id:t.id||"",className:t.className||"",classList:n,tailwindClasses:a,customClasses:s,source:i,hierarchy:o,innerHTMLSnippet:l,outerHTMLSnippet:r,innerTextSnippet:(t.innerText||"").slice(0,200).trim(),computedStyles:m,dataContext:c,rect:{x:Math.round(e.x),y:Math.round(e.y),width:Math.round(e.width),height:Math.round(e.height),top:Math.round(e.top),left:Math.round(e.left),bottom:Math.round(e.bottom),right:Math.round(e.right)},viewport:{width:window.innerWidth,height:window.innerHeight,devicePixelRatio:window.devicePixelRatio||1},url:window.location.href,pageTitle:document.title,timestamp:Date.now()}}class O{constructor(){N(this,"container",null);N(this,"shadowRoot",null);N(this,"highlightBox",null);N(this,"badge",null);N(this,"banner",null);N(this,"currentElement",null);N(this,"isActive",!1);this.handleMouseMove=this.handleMouseMove.bind(this),this.handleClick=this.handleClick.bind(this),this.handleKeyDown=this.handleKeyDown.bind(this),this.handleScroll=this.handleScroll.bind(this)}activate(){this.isActive||(this.isActive=!0,this.createOverlayDOM(),this.bindEvents())}deactivate(){this.isActive&&(this.isActive=!1,this.unbindEvents(),this.removeOverlayDOM(),this.currentElement=null)}toggle(){return this.isActive?(this.deactivate(),!1):(this.activate(),!0)}createOverlayDOM(){if(document.getElementById("uaiselect-overlay-root"))return;this.container=document.createElement("div"),this.container.id="uaiselect-overlay-root",this.container.style.position="fixed",this.container.style.top="0",this.container.style.left="0",this.container.style.width="100vw",this.container.style.height="100vh",this.container.style.zIndex="2147483647",this.container.style.pointerEvents="none",this.shadowRoot=this.container.attachShadow({mode:"open"});const e=document.createElement("style");e.textContent=`
        * {
