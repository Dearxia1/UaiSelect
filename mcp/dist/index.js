...
import { handleGetSelectedElement, handleGetElementPrompt, handleGetComponentHierarchy, handleGetStylesAndProps, handleOpenElementSource, } from './tools.js';
        ...
        tools: [
            {
                ...
                description: 'Retrieves the currently selected UI element from the browser via UaiSelect. Returns component name, exact file path (e.g. src/components/Header.tsx:42), HTML snippet, Tailwind classes, props, and state.',
                inputSchema: {
                    type: 'object',
                    properties: {},
                },
            },
            {
                ...
                description: 'Generates a comprehensive, structured prompt for modifying, fixing, refactoring, or explaining the currently selected UI element.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        mode: {
            ...
            },
            {
                ...
                description: 'Returns the full React / Vue component hierarchy tree from root to the selected UI element.',
                inputSchema: {
                    type: 'object',
                    properties: {},
                },
            },
            {
                ...
                description: 'Returns the computed styles, Tailwind classes, and extracted React / Vue props and state of the inspected element.',
                inputSchema: {
                    type: 'object',
                    properties: {},
                },
            },
            {
                ...
                description: 'Opens the detected source file of the currently selected element in the editor at the exact line number.',
                inputSchema: {
                    type: 'object',
                    properties: {
                        editor: {
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
        ...
        case 'get_element_prompt':
            return handleGetElementPrompt(args || {});
        ...
        case 'open_element_source':
            return handleOpenElementSource(args || {});
        default:
