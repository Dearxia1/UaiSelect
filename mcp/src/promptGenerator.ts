...
export function formatDataContext(data: SelectedElementData): string {
...
export function generatePrompt(
  ...
  mode: 'fix-visual' | 'add-feature' | 'refactor' | 'tailwind-convert' | 'custom' | 'explain' = 'fix-visual',
  userInstruction = ''
): string {
  const componentName =
    data.source?.componentName ||
